    ...
    <header class="navbar-header">
      <div class="navbar-inner">
        ...
        <nav class="navbar-nav">
          ${((s.selected_role||s.role||"").toLowerCase()==="customer"?[{key:"quotations",label:"My Quotations",icon:"request_quote",href:"#/quotations"},{key:"messages",label:"Messages",icon:"chat_bubble",href:"#/messages"},{key:"profile",label:"Profile",icon:"account_circle",href:"#/profile"}]:[{key:"dashboard",label:"Dashboard",icon:"dashboard",href:"#/dashboard"},{key:"quotations",label:"Quotations",icon:"request_quote",href:"#/quotations"},{key:"approvals",label:"Approvals",icon:"verified",href:"#/approvals"},{key:"fulfillment",label:"Fulfillment",icon:"assignment_turned_in",href:"#/fulfillment"},{key:"invoices",label:"Invoices",icon:"receipt_long",href:"#/invoices"},{key:"customers",label:"Customers",icon:"corporate_fare",href:"#/customers"},{key:"products",label:"Products",icon:"inventory_2",href:"#/products"},{key:"pricing",label:"Pricing",icon:"sell",href:"#/pricing"},{key:"subscriptions",label:"Subscriptions",icon:"sync",href:"#/subscriptions"},{key:"reports",label:"Reports",icon:"bar_chart",href:"#/reports"},{key:"messages",label:"Messages",icon:"chat_bubble",href:"#/messages"},{key:"profile",label:"Profile",icon:"account_circle",href:"#/profile"}]).map(r=>{const o=e===r.key||e==="quotation-detail"&&r.key==="quotations"?"nav-item-active":"nav-item-inactive";return`
        <a href="${r.href}" class="nav-item ${o}" data-route="${r.key}">
          <span class="material-symbols-outlined text-lg">${r.icon}</span>
          <span>${r.label}</span>
        </a>
      `}).join("")}
        </nav>
